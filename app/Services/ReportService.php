...
class ReportService implements IReportService{
    public function getGeneralDebtsReport(string $start_date,string $end_date): Generator{
        foreach ($this->getCreditCardReportCursor($start_date,$end_date) as $row) yield $row;
        foreach ($this->getLoansReportCursor($start_date,$end_date) as $row) yield $row;
        foreach ($this->getOthersDebtsReportCursor($start_date,$end_date) as $row) yield $row;
    }
